...
global listOfVehicles
filename = askopenfilename(title="Open Pickle",initialdir=’/’,filetypes=filetype
...
file = asksaveasfile(filetypes = fileextensions, defaultextension = fileextensio
...
button7=Button(window,width=10,text="Create Pickle",bg=’#99CCAA’,command=createPickl
